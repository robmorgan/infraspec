...
func TestGetVirtualCloudEndpoint(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			virtualCloudEnabled: true,
			awsEndpointURL:      "http://localhost:8000",
			expectedEndpoint:    "http://rds-aws.localhost:8000",
			expectedOk:          true,
		},
		{
			...
			service:             "s3",
			virtualCloudEnabled: true,
			expectedEndpoint:    "https://s3-aws.infraspec.sh",
			expectedOk:          true,
		},
		{
		...
		},
		{
			...
			service:             "ec2",
			virtualCloudEnabled: true,
			expectedEndpoint:    "https://ec2-aws.infraspec.sh",
			expectedOk:          true,
		},
		{
			...
			virtualCloudEnabled: true,
			awsEndpointURL:      "http://localhost:8000",
			expectedEndpoint:    "http://sts-aws.localhost:8000",
			expectedOk:          true,
		},
	}
