Feature: RDS Instance Creation
  ...
  Scenario: Create a PostgreSQL RDS instance with basic configuration
    ...
    And I set variable "engine_version" to "13.7"
    And I set variable "instance_class" to "db.t3.micro"
    ...
    Then the output "db_instance_id" should contain "test-postgres-db"
    And the RDS instance "test-postgres-db" should exist
    And the RDS instance "test-postgres-db" should have instance class "db.t3.micro"
  ...
  Scenario: Create a MySQL RDS instance with high availability
    ...
    And I set variable "engine_version" to "8.0"
    And I set variable "instance_class" to "db.t3.small"
    ...
    And I set variable "tags" to
      ...
      | Project     | infratest |
    When I run Terraform apply
    Then the output "db_instance_id" should contain "test-mysql-db"
    And the RDS instance "test-mysql-db" should exist
    And the RDS instance "test-mysql-db" should have instance class "db.t3.small"
