...
func (s *EC2Service) revokeSecurityGroupIngress(ctx context.Context, params map[string]interface{}) (*emulator.AWSResponse, error) {
	...
	sg.IpPermissions = s.removeMatchingRules(sg.IpPermissions, rulesToRevoke)
